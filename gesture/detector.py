...
class Detector:
    ...
    # Hier wird auf gesten reagiert, die nur funktionieren, wenn eine hand erkannt wurde
   ...
   # Hier wird auf gesten reagiert, die nur funktionieren, wenn zwei Hände erkannt wurden
